...
public class ecc_GrowthRate : MonoBehaviour
{
        ...
        if (string.IsNullOrEmpty(id.input))
	{
           ...
           // var script = @"C:\Users\toma_\OneDrive\�rea de Trabalho\escher_python\ecc_growthrate.py";
        ...
        else
        {
           ...
           //var script = @"C:\Users\toma_\OneDrive\�rea de Trabalho\escher_python\ecc_simulations.py";
