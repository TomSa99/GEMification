...
public class hsaa_GrowthRate : MonoBehaviour
{
	...
	if (string.IsNullOrEmpty(id.input))
	{
            ...
            var script = @"C:\Users\toma_\OneDrive\Área de Trabalho\escher_python\hsaa_growthrate.py";
        ...
        else
        {
            ...
            var script = @"C:\Users\toma_\OneDrive\Área de Trabalho\escher_python\hsaa_simulations.py";
            var ID = id.input;
